...
class LocationHelper {
  ...
  static String getLocationPreviewUrl({
    ...
    print(
        'https://maps.googleapis.com/maps/api/staticmap?center=$latitude,$longitude&zoom=16&size=600x300&maptype=roadmap&markers=color:red%7Alabel:A%7C$latitude,$longitude&key=$apiKey');
